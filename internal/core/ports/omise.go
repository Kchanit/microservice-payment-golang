...
type OmiseService interface {
	...
	CreateToken(name string, number string, expirationMonth time.Month, expirationYear int, city string, postalCode string, securityCode string) (*omise.Card, error)
